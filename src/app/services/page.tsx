                        ...
                        <div className="w-full px-4 lg:w-11/12">
                            ...
                            <div className="mb-12">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    {/* Health & Wellness */}
                                    <div className="rounded-sm bg-gradient-to-br from-red-50 to-pink-50 dark:from-gray-dark dark:to-gray-dark p-8 shadow-three dark:shadow-none border-2 border-red-100 dark:border-primary/20 hover:shadow-one transition-all duration-300 group">
                                        <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-red-500 text-white shadow-md mb-6 group-hover:scale-110 transition-transform duration-300">
                                            <Heart size={28} />
                                        </div>
                                        <h4 className="text-xl font-bold text-black dark:text-white mb-4">
                            ...
                            <div className="mb-12 rounded-sm bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 px-8 py-11 border-2 border-primary/30 sm:p-[55px] lg:px-8 xl:p-[55px]">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                    {[
                                        { icon: BookOpen, title: "Education", description: "Strengthening STEM education capacity" },
                                        { icon: Microscope, title: "Research", description: "Applied research for societal challenges" },
                                        { icon: Globe, title: "Environment", description: "Sustainable development solutions" },
                                        { icon: TrendingUp, title: "Innovation", description: "Technology-driven community solutions" }
                                    ].map((item, index) => {
                            ...
                            <div className="mb-12 rounded-sm bg-white px-8 py-11 shadow-three dark:bg-gray-dark sm:p-[55px] lg:px-8 xl:p-[55px] hover:shadow-one transition-shadow duration-300">
                                <div className="flex items-center gap-4 mb-8">
                                    <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-gradient-to-br from-orange-500 to-amber-500 text-white shadow-lg">
                                        <Handshake size={28} />
                                    </div>
                                    <h3 className="text-2xl font-bold text-black dark:text-white">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    {[
                                        ...
                                        <div key={index} className="bg-gray-50 dark:bg-dark p-6 rounded-lg border-t-4 border-primary">
                            ...
                            {/* Student Benefits */}
                            <div className="mb-12 rounded-sm bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-dark dark:to-gray-dark px-8 py-11 shadow-three dark:shadow-none border-2 border-indigo-100 dark:border-primary/20 sm:p-[55px] lg:px-8 xl:p-[55px]">
                                <div className="flex items-center gap-4 mb-8">
                                    <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-indigo-500 text-white shadow-lg">
                                        <Award size={28} />
                                    </div>
                                    <h3 className="text-2xl font-bold text-black dark:text-white">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    {[
                                        ...
                                        <div key={index} className="flex items-start gap-3 bg-white dark:bg-dark p-4 rounded-md shadow-sm">
                                            <div className="flex h-6 w-6 items-center justify-center rounded-full bg-indigo-500 text-white text-xs font-bold flex-shrink-0 mt-0.5">
                                                ✓
                                            </div>
