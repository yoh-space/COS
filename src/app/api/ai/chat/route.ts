...
function getAIModels(): AIModel[] {
    return [
        ...
        },
        {
            ...
            apiKey: process.env.OPENROUTER_API_KEY_SECONDARY || "",
        },
    ];
}
    ...
    try {
        ...
        const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
            ...
            headers: {
                ...
                "HTTP-Referer": process.env.NEXT_PUBLIC_APP_URL || "https://cos.yotech.space",
                "X-Title": "BDU College of Science AI Assistant",
            },
            body: JSON.stringify({
                model: model.model,
                messages: [
